...
def connect_and_subscribe(conn):
    ...
    accessKey = "LTAI5tFy8qvesysNcYjUm3fg"
    accessSecret = "f1ZpsQf6xZ8ZRqx5m1LXtorUBJXA4x"

    consumerGroupId = "DEFAULT_GROUP"
    # iotInstanceId：实例ID。
    iotInstanceId = "iot-06z00io7j40fpat"

    clientId = "112.2.251.114:8044"
...
conn = stomp.Connection([('iot-06z00io7j40fpat.amqp.iothub.aliyuncs.com', 61614)], heartbeats=(0, 300))
conn.set_ssl(for_hosts=[('iot-06z00io7j40fpat.amqp.iothub.aliyuncs.com', 61614)], ssl_version=ssl.PROTOCOL_TLS)
