...
radius = 0.07
pcd = o3d.io.read_point_cloud(r"C:\Users\史经辞\Desktop\bag_pcds\120.pcd")
...
scatter = plt.scatter(points[:, 0], points[:, 1], c=points[:, 2], cmap='viridis', edgecolor='k')
...
plt.xlabel('X')
plt.ylabel('Y')
plt.title('point of cloud')
plt.savefig(r"D:\python_base\scatter_plot.png")
#plt.show()
